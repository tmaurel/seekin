    ...
    <body>  
      ...
      <g:form class="boxed_form" name="crud_panel" action="save" method="post" >
                ...
                <p>
                      ...
                      <g:textField name="title" class="field${hasErrors(bean:linkInstance ,field:'title','error')}" value="${linkInstance.title}" />

                </p>
          
                <p>
                      <label for="url"><g:message code="link.url" default="Url" />:</label>
                      <g:textField name="url" class="field${hasErrors(bean:linkInstance ,field:'url','error')}" value="${linkInstance.url}" />

                </p>
          
                <p>
                      <label for="description"><g:message code="link.description" default="Description" />:</label>
                      <g:textField name="description" class="field${hasErrors(bean:linkInstance ,field:'description','error')}" value="${linkInstance.description}" />
